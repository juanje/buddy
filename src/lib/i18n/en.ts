...
export const en: LocaleStrings = {
  ...
  orientationNotifications: "Notifications",
  orientationNextTasks: "Next tasks",
  orientationNoTasks: "No open tasks.",
  orientationWhereWeLeftOff: "Where we left off",
  oauthSignIn: "Sign in",
  ...
  settingsJiraSaved: "Saved.",
  settingsJiraRestart: "Saved. Restart the session to activate the change.",
  settingsJiraStatusConnected: "Connected",
  jiraError401: "Check your API token in Settings → Integrations → Jira.",
  jiraError403: "Check your Jira permissions for this account.",
  jiraError404: "The issue may have been deleted or moved.",
  jiraError429: "Wait and try again, or reduce the frequency of requests.",
  jiraError5xx: "Jira may be down — try again later.",
  jiraErrorNetwork: "Check your network connection and Jira URL.",
  jiraErrorTimeout: "Check your network connection and try again.",
  jiraErrorGeneric: "Check the Jira URL and credentials in Settings.",
  jiraErrorNotConfigured: "Configure Jira in Settings → Integrations.",
  settingsSlackTitle: "Slack",
  settingsSlackEnabled: "Enable Slack",
  settingsSlackToken: "Session token (xoxc)",
  settingsSlackCookie: "Session cookie (xoxd)",
  settingsSlackShowSecrets: "Show credentials",
  settingsSlackHideSecrets: "Hide credentials",
  settingsSlackExtractHint: "Extract session credentials with",
  settingsSlackTestConnection: "Test connection",
  settingsSlackTesting: "Testing…",
  settingsSlackSave: "Save",
  settingsSlackSaved: "Saved.",
  settingsSlackRestart: "Saved. Restart the session to activate the change.",
  settingsSlackStatusConnected: "Connected",
  slackError401: "Re-extract session credentials in Settings → Integrations → Slack.",
  slackError403: "Check your Slack workspace permissions for this account.",
  slackError404: "The channel, thread, or user may not exist or is inaccessible.",
  slackError429: "Wait and try again — Slack rate limits are strict.",
  ...
  slackErrorEnterprise: "Your corporate Slack workspace restricts this operation (e.g. listing channels). Do NOT attempt to find the information through other tools or searches. Tell the user about the restriction and ask them to provide a direct Slack URL or channel/DM ID so you can use the thread or channel_history actions instead.",
