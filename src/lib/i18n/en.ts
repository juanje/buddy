...
export const en: LocaleStrings = {
  ...
  unsupportedSpreadsheet: "Spreadsheet files aren't supported directly — export to CSV from your spreadsheet app and attach that instead",
  unsupportedDocument: "Unsupported document format — export to .md or .txt",
  toolReading: "Reading…",
  ...
  settingsTokenExpired: "Token expired — Sign in",
  authErrorCardTitle: "Session expired",
  authErrorCardBody: "Your {provider} session has expired. Go to Settings to sign in again.",
  authErrorCardOpenSettings: "Go to Settings",
  authErrorCardDismiss: "Dismiss",
  settingsUsage: "Usage",
