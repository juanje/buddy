...
- **Personal knowledge base (wiki)** — your second brain: save ideas and concepts, ingest documents into an interconnected wiki with cross-references and search. This is where your knowledge lives; Buddy's own memory stays separate.
