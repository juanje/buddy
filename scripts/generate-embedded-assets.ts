// scripts/generate-embedded-assets.ts — E12: snapshot templates/ and
// bundled/prompts/ into a TS module so the compiled sidecar carries them
// (the repo tree is not on disk inside a bun binary).
//
...
const banner =
  ...
  "// Snapshot of templates/ and bundled/prompts/ for the compiled sidecar (E12).\n\n";
...
console.log(
  `Embedded assets generated: ${Object.keys(templates).length} template files, ${Object.keys(prompts).length} prompts`,
);
