...
import { APP_LOGS_DIR, REFLECT_SESSIONS_DIR } from "../../shared/defaults";
...
describe("pruneSessionArtifacts", () => {
  it("prunes both event logs and forks in one pass", () => {
    ...
    expect(pruneSessionArtifacts(root, NOW)).toBe(2);
